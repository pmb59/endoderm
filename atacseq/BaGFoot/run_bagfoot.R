...
bamfile1= '../ATAC11-12.bam';  
cc1 = countReadsBAM(bamfile1, refgenome = "hg19");  # counts the number of cuts in the sequence file.
cc1
cutcountfile1 = makeCutCountBAM(bamfile1, refgenome = "hg38");   # generate a BedGraph file with Tn5 insertion counts

bamfile2= '../ATAC13-14.bam';
...
system(' bedtools multicov -bams ../ATAC11-12.bam -bed pooledBed.bed > NcountsFile1.bed')
system(' bedtools multicov -bams ../ATAC13-14.bam -bed pooledBed.bed > NcountsFile2.bed')
...
T24 <- CutCount(file = "../ATAC11-12_AC_cutcount.bgr.gz"  , count = NcountsFile1, name = "T24" ); 
T48 <- CutCount(file = "../ATAC13-14_AC_cutcount.bgr.gz"  , count = NcountsFile2, name = "T48" );

motifdb_mm10 <- MotifDB(motiflistfile = 'motiflist_hg38_cisbp_filtered.txt',   # This file contains the list of FIMO outputs file
			directory='../hg38_cisbp_fimo/');	               # Directory of FIMO outputs

gfootoption_fed_fasted <- GFootOption(biasfile = "Hexamer_withoutMap.txt",                    # Hexamer bias frequency table 
					hexamer_pattern= "nuccode_hg38_6mer_{chr}.dat");      # nuc. code files generated by MakeBiasCorrectionTableBAM 


# Definition of BaGFoot analysis 
GFoot_fed_fasted= GFoot(control = T24,               ##  Control Data defined above
			treatment = T48, 		 ##  Treatment Data defined above
			sitefile = "consolidated_hotspot.csv",  ##  Sites file: Peak File.  This file must have "chr", "st", "ed" in the header.
